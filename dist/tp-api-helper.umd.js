(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('request'), require('fs')) :
	typeof define === 'function' && define.amd ? define(['exports', 'request', 'fs'], factory) :
	(global = global || self, factory(global.Targetprocess = {}, global.request, global.fs));
}(this, function (exports, request, fs) { 'use strict';
	...
	exports.DeleteEntity = tpApiHelper_6;
	exports.GetEntity = tpApiHelper_3;
	exports.Operation = tpApiHelper_2;
	exports.PostEntity = tpApiHelper_4;
	exports.PostFile = tpApiHelper_5;
	exports.TargetProcess = tpApiHelper_1;
	exports.default = tpApiHelper$1;
